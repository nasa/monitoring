# Validate operational intent not changed test step fragment

Not used. This step verifies that a previous action did not result in a operational intent being changed in the DSS.
...
See `OpIntentValidator.expect_not_changed()` in [test_steps.py](test_steps.py).
...
## 🛑 Operational intent not changed check
